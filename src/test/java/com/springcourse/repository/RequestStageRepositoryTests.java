...
public class RequestStageRepositoryTests {
	...
	public void AsaveTest() {
		...
		RequestStage stage = new RequestStage(null, "Foi compraod um novo laptop de marca HP e com 16 GB de RAM",
	...
	public void getByIdTest() {
		...
		assertThat(stage.getDescription()).isEqualTo("Foi compraod um novo laptop de marca HP e com 16 GB de RAM");
	}
